from iterative.service.utils.service_utils import (find_project_service_functions_in_config_path, 
...
@pytest.mark.parametrize("function_finder,expected_function_name,expected_file_name", [
    ...
    (find_project_service_functions_in_config_path, 'find_project_service_functions', 'service_utils.py'),
...
def test_function_finder(function_finder, expected_function_name, expected_file_name):
    ...
    assert functions[expected_function_name].endswith(expected_file_name)